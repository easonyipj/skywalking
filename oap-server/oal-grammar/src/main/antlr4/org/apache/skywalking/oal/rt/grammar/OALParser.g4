...
source
    : SRC_SERVICE | SRC_DATABASE_ACCESS | SRC_SERVICE_INSTANCE | SRC_ENDPOINT |
      ...
      SRC_EVENT | SRC_SERVICE_INSTANCE_GOLANG_STACK | SRC_SERVICE_INSTANCE_GOLANG_HEAP | SRC_SERVICE_INSTANCE_GOLANG_GC_NUM |
      SRC_SERVICE_INSTANCE_GOLANG_GC_PAUSE_TIME | SRC_SERVICE_INSTANCE_GOLANG_GOROUTINE_NUM | SRC_SERVICE_INSTANCE_GOLANG_THREAD_NUM |
      SRC_SERVICE_INSTANCE_GOLANG_CPU_USED_RATE | SRC_SERVICE_INSTANCE_GOLANG_MEM_USED_RATE
    ;
